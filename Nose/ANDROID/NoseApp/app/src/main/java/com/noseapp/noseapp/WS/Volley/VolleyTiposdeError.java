...
public class VolleyTiposdeError implements Parcelable {
     ...
     */
    public static VolleyTiposdeError createVolleyErrorNoNetwork() {
        VolleyTiposdeError dataError = new VolleyTiposdeError();
     ...
     * @return
     */
    public static VolleyTiposdeError createVolleyError(String msgTitle, String msgContent) {
        VolleyTiposdeError dataError = new VolleyTiposdeError();
    ...
    public VolleyTiposdeError() {

    }

    public VolleyTiposdeError(VolleyError error) {
        this(error, null);
    }

    public VolleyTiposdeError(VolleyError error, Request request) {
        VolleyTiposdeError dataError = VolleyProcesadordeResultado.parseErrorResponse(error);
        ...
        if (util.isNotEmpty(messageTitle))
    ...
    protected VolleyTiposdeError(Parcel in) {
    ...
    public static final Creator<VolleyTiposdeError> CREATOR = new Creator<VolleyTiposdeError>() {
        @Override
        public VolleyTiposdeError createFromParcel(Parcel in) {
            return new VolleyTiposdeError(in);
        }

        @Override
        public VolleyTiposdeError[] newArray(int size) {
            return new VolleyTiposdeError[size];
        }
    };
